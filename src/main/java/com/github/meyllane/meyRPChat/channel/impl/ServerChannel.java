...
public class ServerChannel extends BaseChannel<BaseChatContext> {
    public ServerChannel(String format, ChannelOption options) {
    ...
    public void send(BaseChatContext ctx) {
        ...
        Stream<? extends Player> targets = ctx.getSender().getServer().getOnlinePlayers().stream();
